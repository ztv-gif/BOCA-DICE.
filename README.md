...
<main>
  <!-- Formulario de login para editar -->
  ...
  <!-- Formulario para agregar noticias (oculto hasta ingresar contraseña) -->
  ...
  <!-- Formulario para agregar partidos (oculto hasta ingresar contraseña) -->
...
<script>
  // Contraseña para edición (cambiá "1234" por la que quieras)
  const PASSWORD = "1234";
